...
def _get_message(obj_dict):
    ...
    question_template = f"{obj_dict['question']} {choice_str} Let's think step by step. Output the thinking process in <think> </think> and final answer in <answer> </answer>."
